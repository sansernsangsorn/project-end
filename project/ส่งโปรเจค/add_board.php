	...
	<div class="data_center_back">
	  <table width="100%" height="400" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <div class="title">
                <h2><img src="images/diagram-04.png" width="48" height="48" /> ตั้งกระทู้ถาม</h2>
              </div>
              <p>
...
<td height="50" colspan="4" align="left" valign="middle" style="border-bottom: 1px solid #f4f4f4;"><div style="padding:10px; font-size:15px; font-weight:bold; border-bottom: 1px solid #eee;">
 ...
 ?>
                    ...
                    <tr>
                      <td align="right" valign="middle"><span style="width: 12%;">รูปภาพ : </span></td>
                      <td>
					  <input name="radiobutton" type="radio" value="001.png" checked="checked" />
                          <img src="images/icon_board/001.png" border="0" />
                          <input name="radiobutton" type="radio" value="002.png" />
                          <img src="images/icon_board/002.png" border="0" />
                          <input name="radiobutton" type="radio" value="003.png" />
                         <img src="images/icon_board/003.png" border="0" />
                          <input name="radiobutton" type="radio" value="004.png" />
                         <img src="images/icon_board/004.png" border="0" />
                          <input name="radiobutton" type="radio" value="005.png" />
                         <img src="images/icon_board/005.png" border="0" />
                          <input name="radiobutton" type="radio" value="006.png" />
                         <img src="images/icon_board/006.png" border="0" />
                          <input name="radiobutton" type="radio" value="007.png" />
                         <img src="images/icon_board/007.png" border="0" /> </td>
                    </tr>
                    <tr>
...
<?PHP
		...
		?>
			...
			<img src="images/icon_board/<?=$result['topic_photo']?>" border="0" /> <?=$result['topic_title']?>
