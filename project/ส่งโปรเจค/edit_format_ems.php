	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" valign="top"><div class="title">
              <h2><img src="images/pencil_48.png" width="48" height="48" />แก้ไขรูปแบบการจัดส่งสินค้า</h2>
          </div>
              <p>&nbsp;</p>
...
?>		
            <form action="<?PHP $_SERVER['PHP_SELF']?>" method="post" name="form1" id="form1" enctype="multipart/form-data" onsubmit="return chk_txt();" >
                <script language="JavaScript" type="text/javascript">
				  	function chk_txt(){
							if(document.form1.txt_name.value==""){
									alert("กรุณากรอก ข้อมูลรูปแบบการจัดส่งด้วยนะ");
									document.form1.txt_name.focus();
									return false;
							}
							else if(document.form1.txt_price.value==""){
									alert("กรุณากรอก ราคา ด้วยนะ");
                ...
                <tr>
                    ...
                    <td width="80%" height="22" align="left" valign="middle"><input name="txt_name" type="text"  id="txt_name" style="width: 250px;" accesskey="p" value="<?=$rs['ems_name']?>" /></td>
                  </tr>
                  <tr>
                    <td height="22" align="right" valign="middle"><strong>ราคา :</strong></td>
                    <td height="22" align="left" valign="middle"><input name="txt_price" type="text"  id="txt_price"  style="width: 70px;" accesskey="p" value="<?=$rs['ems_price']?>" /></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td height="22" align="left" valign="middle"><input type="submit" name="btnSubmit" id="btnSubmit" value="บันทึกข้อมูล" />
                        ...
                        <input type="hidden" name="ID"  value="<?=$rs['ems_id']?>"/>
						<input type="hidden" name="m_page" value="<?=$link_page?>" />
						</td>
                  </tr>
				  </form>
                </table>
...
<div id="footer_front">
	<div class="data_footer">
      <p>
		...
		if($_POST){
		// แก้ไขข้อมูล
		$sql_update = mysqli_query($con,"UPDATE  ".$ems." SET  ems_name='".$_POST['txt_name']."', ems_price ='".$_POST['txt_price']."'  WHERE ems_id='".$_POST['ID']."'");
		
		// ถ้าแก้ไขข้อมูล
		if($sql_update){						
				echo "<script>alert('บันทึกข้อมูลเสร็จแล้ว')</script>";
				echo "<meta http-equiv='refresh' content='0; url=admin_format_ems.php?m_page=3'>";
			}else{
