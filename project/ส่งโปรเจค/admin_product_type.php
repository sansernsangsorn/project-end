...
?>
            <tr>
              <td align="left" valign="top">
                <div class="title">
                    <h2><img src="images/diagram-60.png" width="48" height="48" /> ประเภท : <?=$type_name?> </h2>
                </div>
...
if(!$_GET['ID']==""){
	...
	$Query = mysqli_query($con,"SELECT * FROM ".$product." WHERE prd_type='".$_GET['ID']."' ORDER BY prd_id DESC LIMIT $start,$limit"); //คิวรี่คำสั่ง
}else{
