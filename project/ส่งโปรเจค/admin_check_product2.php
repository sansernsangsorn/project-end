	  ...
	  <table width="100%" height="850" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="left" valign="top">
                <div class="title">
                    <h2><img src="images/diagram-60.png" width="48" height="48" />ใบจัดซื้อผ่านการตรวจรับสินค้าแล้ว</h2>
                </div>
				<p>&nbsp;</p>
                <p>
                  <?php  
...
$q="SELECT * FROM ".$order_in." WHERE ordin_status='Y' ORDER BY ordin_id DESC";  
		...
		?>
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="25%" align="left" valign="middle" bgcolor="#999999" class="sell"><strong>&nbsp;ชื่อผู้จัดซื้อสินค้า</strong></td>
                      ...
                      <td width="10%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>รับสินค้า</strong></td>
...
?>
                    <li>
                      <tr>
						...
						[<a href="print_check_ordin.php?m_page=<?=$_GET['m_page']?>&amp;ID=<?=$Result['ordin_id']?>">ตรวจรับ</a>]
						</td>
