	 ...
	 include "connect_db.php";
		...
		?>
                <tr>
                  ...
                  <div style="padding:5px; margin-left: 40px; margin-right: 10px; border:0px solid #666;"><?=$result['topic_title']?>
				  </div>
                        ...
                        <table width="100%" border="0">
                          ...
                          <tr>
                            ...
                            <td><input type="submit" name="btnSubmit" id="btnSubmit" value="ตอบกระทู้" />
								...
								<img src="images/icon-03.png" width="16" height="16" /> [<a href="add_board.php">ตั้งกระทู้คำถามใหม่</a>] </td>
                          </tr>
                        </table>
                    </form>
                    </div></td>
	 ...
	 ?>
		...
		?>
                <tr>
                  ...
                  <td align="left" valign="middle" class="sell1" style="padding:3px;"><a  style="text-decoration:none;"href="update_board.php?ID=<?=$result['topic_id']?>"> <img src="images/icon_board/<?=$result['topic_photo']?>" border="0" />
                        <?=$result['topic_title']?>
