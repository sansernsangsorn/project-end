		...
		?>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="9%" height="30" align="center" valign="middle" bgcolor="#999999" class="sell"><strong>ข้อมูล</strong></td>
...
?>
                        <li>
                          <tr>
							...
							<?PHP
// ถ้าสถานะเท่ากับ 1  คือ  ข้อมูลสั่งซื้อสิค้าใหม่ยังไม่ชำระเงิน
	if($status_ord=='Y'){
						echo "<samp style='color: red;'>ยังไม่ชำระเงิน</samp>";
						
						}else if($status_ord=='2'){ // 2 คือสถานะ คือ แจ้งชำระเงินผ่านหน้าเว็บไซต์
						echo "<samp style='color: green;'>กำลังตรวจสอบ</samp>";
						
						}else if($status_ord=='3'){ // 3 คือสถานะ คือ ตรวจสอบการชำระเงินแล้ว รออนุมัติสินค้า
						echo "<samp style='color: blue;'>ชำระเงินแล้ว</samp>";
						
						}else if($status_ord=='4'){ //4 คือสถานะ คือ อนุมัติสินค้าแล้ว รอส่งสินค้า
						echo "<samp style='color: #FF6600;'>อนุมัติสินค้าแล้ว</samp>";
						
						}else if($status_ord=='5'){ // 5 คือสถานะ จัดส่งสินค้าแล้ว
						echo "<samp style='color: #660033;'>รอส่งสินค้า</samp>";
											
						}else if($status_ord=='6'){ // 6 คือสถานะ ยกเลิกใบสั่งซื้อสินค้า
				...
				?></td>
                            <td width="9%" height="20" align="center" valign="middle" bgcolor="#F0F0F0" class="sell1">
							[<a href="print.php?ID=<?=$Result['ord_id']?>&amp;ord=1">ข้อมูล</a>]</td>
