...
<div style="float:left; line-height:18px;">
		<ul style="list-style:none; padding-left:5px;">
			...
			<li><img src="images/0025_bullet.png" width="12" height="12" border="0" /> <?=$DetailPrd?></li>
			<li><img src="images/0025_bullet.png" width="12" height="12" border="0" /> <b>ต้นทุน</b> : <?=number_format($result['prd_capital'],2)?> บาท</li>
			<li><img src="images/0025_bullet.png" width="12" height="12" border="0" /> <b>ขาย</b> : <?=number_format($result['prd_price'],2)?> บาท</li>
			<li>
